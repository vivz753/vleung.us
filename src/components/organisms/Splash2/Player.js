...
const Player = ({ children, url}) => {
  ...
  return (
    <div className="relative" onClick={toggle}>
      <button className="bg-yellow-500 rounded-full w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 border-yellow-700 border-b-8 hover:bg-yellow-600 focus:bg-yellow-700 focus:outline-none">
